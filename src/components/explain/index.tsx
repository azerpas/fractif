            ...
            <Stack align={'center'} justify={'center'}>
              <Center mt="20px">
                <Flex flexDirection="row" >
                  <Center mr="25px">
                    <Text
                      textDecoration="underline" textDecorationColor="#2F80CB" textDecorationThickness="2px"
          ...
          <>
            <Center mt="20px">
              <Flex flexDirection="row">
                ...
                <Center ml="25px">
                  <Text color="gray.600" textDecoration="underline" textDecorationColor="#2F80CB" fontWeight="medium" onClick={() => setexplain(false)}>Selling</Text>
                </Center>
              </Flex>
            </Center>
            <Center>
